...
QT_MOC_LITERAL(5, 60, 21), // "signal_preset_changed"
QT_MOC_LITERAL(6, 82, 6), // "preset"
...
QT_MOC_LITERAL(24, 551, 19) // "on_btnSave_released"
    ...
    "fx\0signal_dialogFx_open\0signal_preset_changed\0"
    ...
    "on_btnPreset3_released\0on_btnPreset4_released\0"
    "on_btnPreset5_released\0on_btnPreset6_released\0"
    "on_btnSave_released"
};
...
void MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->signal_preset_changed((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (MainWindow::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::signal_preset_changed)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindow::signal_preset_saved)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 2
void MainWindow::signal_preset_changed(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 3
void MainWindow::signal_preset_saved()
{
